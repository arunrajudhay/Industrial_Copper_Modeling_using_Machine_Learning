...
with tab1:    
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open(r"C:\CAPSTONE\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'C:\CAPSTONE\scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"C:\CAPSTONE\t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"C:\CAPSTONE\s.pkl", 'rb') as f:
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"C:\CAPSTONE\cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r'C:\CAPSTONE\cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"C:\CAPSTONE\ct.pkl", 'rb') as f:
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by ARUNRAJ R U</h6>', unsafe_allow_html=True )  
